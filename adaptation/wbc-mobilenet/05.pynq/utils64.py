...
Fixed-point scheme `ap_fixed<24, 12>` (24 total bits, 12 integer, 12
fractional), so FX_FRAC_BITS = 12. Same as v0.3/v0.4.

v0.4: each image is 64x64x3, flattened to 12288 values
