...
#   3. Source wbc64_v05_bd.tcl (block design adapted from ICTP)
...
set proj_name    "wbc64_v05_mobilenet"
set proj_dir     [file join $script_dir vivado_prj]
set ip_repo_dir  [file normalize [file join $script_dir .. 03.hls myproject_accel64_v05_prj solution1 impl ip]]
set bd_script    [file join $script_dir wbc64_v05_bd.tcl]
set design_name  "machineLearning_bd"
set part         "xczu3eg-sfvc784-2-e"
set board_part   "realdigital.org:aup-zu3-8gb:part0:1.0"
set xsa_name     "bd_wrapper_wbc64_v05.xsa"
...
#
# v0.5: 32 GB host. v0.4 ran at 8 threads / 4 jobs and peaked at 21.7 GB
# (of 31 GB usable) during synthesis, briefly touching swap. v0.5 is a ~2x
# larger network, so we throttle to 4 threads / 2 jobs to keep the RAM peak
# comfortably away from swap. The BD stays in global synth mode
# (synth_checkpoint_mode None above) so no parallel OOC sub-runs spawn.
set_param general.maxThreads 4

puts "INFO: Launching synthesis (32 GB host, 4 threads / 2 jobs)"
