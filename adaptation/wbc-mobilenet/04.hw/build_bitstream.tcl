...
# build_bitstream.tcl
#
# Orchestrates the full Vivado flow for v0.3 (BloodMNIST CNN 48x48):
#   1. Create Vivado project targeting the AUP-ZU3 board
#   2. Register the hls4ml-generated IP repository
#   3. Source wbc_bd.tcl (block design adapted from ICTP)
