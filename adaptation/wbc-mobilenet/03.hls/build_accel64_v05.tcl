# build_accel64_v05.tcl  (v0.5, 64x64, wider 32->48->96 net)
#
...
#
# Input:  hls4ml C++ project at ../02.hls4ml/output/myproject_wbc64_v05_prj
# Output: ./ip (note: export_design ignores -output for the packaged IP
#         location and writes to solution1/impl/ip).

set hls4ml_prj "../02.hls4ml/output/myproject_wbc64_v05_prj"
set firmware   "${hls4ml_prj}/firmware"

open_project -reset myproject_accel64_v05_prj

set_top myproject_wbc64_v05_accel
...
add_files myproject_wbc64_v05_accel.cpp    -cflags "-std=c++14 -I${firmware} -I."
add_files myproject_wbc64_v05_accel.h
